<template>
  <div class="school">
    ...
    <student-table type="school" @update="showUpdateDialog" :data="list" :loading="loading" :fromIndex="fromIndex" />
...
import { fetchStudentByPage, fetchStudentByStuId, updateStudent } from '@/api/student/schoolAdmin'
export default {
  data() {
    return {
      list: [],
